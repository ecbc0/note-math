...
cf. #link(<Klein__Gordon_Lagrangian>)[Action of scalar field]
...
#indent[
  ...
  $
  Generally, region change is given by $exp(a(x))$ #link(<vector_field_as_δ_diffeomorphism>)[by δ diffeomorphism] $a(x)$ 
  $
...
#indent[
  ...
  #tag("angular_momentum_KG") let $T$ be the energy-momentum tensor of the KG field. The angular momentum of the field
  $
    M = [x,T]
  $
  or
...
#indent[
  ...
  $
  $- ϕ^* ∂ ϕ + ϕ ∂ ϕ^*$ is called the 4-current of the KG field #tag("current_gauge_KG")

  $- ϕ^* ∂ ϕ + ϕ ∂ ϕ^* = - Im(ϕ^* ∂ ϕ)$ 

  Fixing the $ℝ^(1,3)$ coordinates, and considering the 4-current components as quantities integrable over $ℝ^3$, then the zero component, i.e., charge conservation, holds #tag("conserved_spatial_integral_charge_KG")
