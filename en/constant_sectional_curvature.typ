...
#indent[
  According to #link(<symmetry_of_curvature>)[], $"curvature" subset ⨀^2 ⋀^2 V^⊺$
...
#tag("quadratic_manifold_is_constant_sectional_curvature") Quadratic manifold $ℚ^(p,q)(± a^2)$ has constant-sectional-curvature $R = 1/(± 2 a^2) g #cvt-prod g$
