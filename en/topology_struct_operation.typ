...
#tag("closed_in_subspace") #link(<closed>)[] Characterization of in subspace
#indent[
  $S' ⊆ S ==> "closed"(S',#T _S) = S ∩ "closed"(S',#T _X)$

  *Example* $"closed"((0,1],#T _((0,1])) = (0,1] ≠ [0,1] = "closed"((0,1],#T _ ℝ)$

  Indicates that $"closed"(S',#T _X)$ may have #link(<limit_point>)[limit point] $∉ S$ or $in "closed"(S,#T _X) ∖ S$, but the limit point of $"closed"(S',#T _S)$ can only be $in S$
