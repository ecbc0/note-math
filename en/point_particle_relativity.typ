...
#tag("action_point_particle_relativity") Action $ integral #d l (m c) = integral #d τ (m c|vel(x)|)  $ The result is a geodesic
...
#tag("equation_point_particle_relativity") let $L(x,v) = m c^2 (1 - (v/c)^2)^(1/2)$. Similar to #link(<point_particle_Lagrange_equation>)[the non-relativistic case], the equation of action 
$ 
  (∂ L)/(∂ x) - (#d)/(#d t) (∂ L)/(∂ v) 
  
  <==> (#d)/(#d t) (m c^2 v)/((1 - (v/c)^2)^(1/2)) = 0 
$
#tag("point_particle_relativity_approximate_to_non_relativity") The relativistic action "approximates" to the non-relativistic action 
$
...
- Translation
#indent[
  Using time coordinates. Similar to the non-relativistic case, the relativistic versions of #link(<energy_point_particle_non_relativity>)[energy] and #link(<momentum_point_particle_non_relativity>)[momentum] are #tag("energy_momentum_point_particle_relativity")
  $
    E &= (∂ f)/(∂ v) ⋅ v - f 
    &quad quad p &= (∂ f)/(∂ v) \
...
- Rotation
#indent[
  Similar to the non-relativistic case, the relativistic version of #link(<rotation_momentum_point_particle_non_relativity>)[momentum-point-particle-non-relativity] is #tag("rotation_momentum_point_particle_relativity")
  $
...
- boost
#indent[
  boost by #link(<hyperbolic_angle>)[hyperbolic angle]
  $
    exph θ #i-split = mat(
      cosh θ, sinh θ; 
      sinh θ, cosh θ
...
#indent[  
  ...
  #tag("current_gauge_particle") Can this hidden $#U (1)$ gauge symmetry give a conserved 4-current for a point particle? $(ρ,#j) = j = ρ (1,#v) = ρ v$ 
]
#let A = bf("A")
#let j = bf("j")
#let v = bf("v")
...
#indent[  
  ...
  #tag("current_gauge_particle") Can this hidden $#U (1)$ gauge symmetry give a conserved 4-current for point particles? $(ρ,#j) = j = ρ (1,#v) = ρ v$ 
]