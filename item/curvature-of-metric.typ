...
#tag("flat-metric-iff-curvature-0") flat-metric <==> 曲率是零
...
#tag("algebraic-curvature-tensor") 代数曲率张量定义为满足上述对称性 (@ref-6, lect 8) 
...
#tag("dimension-of-algebraic-curvature") 使用 $("domain")/("kernel") ≃ "image"$, 有代数曲率张量空间的维数 
