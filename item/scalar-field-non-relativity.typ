...
#indent[
  ...
  on ${|ψ|^2 = 1}$, let $Δ ψ in ψ^⟂$ ($Re ⟨ Δ ψ , ψ ⟩ = 0$ 的意义上)
  
  能量期望是二次型, 其一阶微分 $Re ⟨ Δ ψ mid(|) #H mid(|) ψ ⟩ = 0$ forall $Δ ψ in ψ^⟂$ ==> $#H ψ in ψ^(⟂ ⟂) = span{ψ}$ ==> exists $E in ℝ, #H ψ = E ψ$
  ...
  能量期望是二次型, 其二阶微分的多项式 $⟨ Δ ψ mid(|) #H mid(|) Δ ψ ⟩$
