...
*Proof* define $b_n = a^n/n!$. use 几何级数收敛判别 $b_(n+1)/b_n = a/n -> 0 < 1$

$n!$ 对应 ${1 ,…, n}$ 自双射数量, $n^n$ 对应 ${1 ,…, n}$ 自映射数量. $n^(n^n)$ 等类似

#tag("iterated-power-vs-factorial") $lim_(n -> ∞) n!/n^n = 0$

*Proof* define $b_n = ⋯$. use 几何级数收敛判别 $b_(n+1)/b_n = (n/(n + 1))^n -> 1/e < 1$
...
*Proof* $a_n = 1 + 1/2 + ⋯ + 1/n$ 发散 by 它不是 #link(<Cauchy-completeness-real>)[limit-distance-vanish]. e.g.
