...
$SO(2)$ 的元素的乘法等价于 $ℂ$ 的长度 $1$ 元素的乘法. recall $ℂ$ 是 #link(<normed-algebra>)[] $|a b| = |a| |b|$
...
#indent[
  ...
  $
  或者使用 #tag("Euler-formula") $exp #i t = cos t + #i sin t ≃ mat(cos(t),-sin(t);sin(t),cos(t))$, 然后用 $ℂ$ #link(<exponential>)[指数函数] 和复数乘法 $exp #i (s+t) = exp #i s ⋅ exp #i t$
]
于是 $ℝ ↠ SO(2) ≃ 𝕊 ≃ #U (1,ℂ)$
