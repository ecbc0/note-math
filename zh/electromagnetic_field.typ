...
类似于 #link(<flat_metric_iff_curvature_0>)[]
...
#indent[
  ...
  *Question* 如何让 $sum_i ∂_i (∂_i A_j - ∂_j A_i) = 0$ 显然地蕴含电磁场 $E,B$ 的方程的 $div, curl$ 形式? #tag("Maxwell_equation")
  $
  ...
  使用特殊的规范 #tag("Lorentz_gauge") $#d^† A =0$, 方程 $#d^† #d A = 0$ 变为 
  $
