...
#tag("analytic_struct_product") 积空间
#indent[
  不对称性: $V != W$ ==> 没有 $V ⊙ W$
...
#indent[
  ...
  $1/(1-g)$ 的收敛半径受到 $1/(1-x)$ 的收敛半径 $1$ 的控制
...
#indent[
  ...
  #indent[
    ...
    $
    $c_1 = a_1 b_1$. 写为微分 #tag("chain_rule_1d") 
  ...
  #indent[
    ...
    $C_1 (v) = A_1 (B_1 (v))$, 写为微分就是 #tag("chain_rule")
...
#indent[
  ...
  #indent[
    ...
    *Question* 其实两种方法看起来都很 ad hoc? 有无更受到逆函数本身的直观所启发的方法? 例如是否能联系到映射 $map(GL, GL, A, A^(-1))$ 的 "解析性"?
  ]
]
