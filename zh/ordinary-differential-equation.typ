...
#tag("vector-field-as-δ-diffeomorphism") 在局部解析同胚 $𝟙$ 附近, 向量场 $v$ 是局部解析同胚群的坐标 $v ⇝ exp v$. 这类似于 #link(<geodesic-coordinate>)[]
...
#indent[
  $"Diff"$ 的 #link(<conjugate-action>)[共轭作用] $(f,g) ⇝ f g f^(-1)$ 
