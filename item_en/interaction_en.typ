...
In the equation, the 4-current of the field becomes the source of the gauge potential (#raw("#link(<current-gauge-spinor>)[spinor field 4-current]") #raw("#link(<current-gauge-KG>)[scalar field 4-current]") #raw("#link(<current-gauge-particle>)[point particle 4-current]"))